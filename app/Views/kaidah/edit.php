...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold text-dark">Edit Kaidah</h4>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active">Edit Kaidah</li>
            </ol>
        </nav>
    </div>
    <div>
        <a href="<?= site_url('kaidah/' . $kaidah['id_materi']) ?>" class="btn btn-outline-secondary me-2">
...
<form action="<?= site_url('kaidah/' . $kaidah['id_materi']) ?>" method="post" id="kaidahForm" enctype="multipart/form-data">
    <?= csrf_field() ?>
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="judul_kaidah" name="judul_kaidah"
                               value="<?= esc($kaidah['judul_kaidah']) ?>" required
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" required
                                  placeholder="Deskripsi singkat tentang kaidah ini..."><?= esc($kaidah['deskripsi']) ?></textarea>
                        <div class="char-counter">
                            <span id="deskripsiCount"><?= strlen($kaidah['deskripsi']) ?></span> / 500 karakter
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="penjelasan" name="penjelasan" rows="6"
                                  placeholder="Tulis penjelasan lengkap tentang kaidah ini..."><?= esc($kaidah['penjelasan'] ?? '') ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Preview Teks Arab:</label>
                        <div class="preview-box" id="arabicPreview">
                            <?php if (!empty($kaidah['penjelasan'])): ?>
                                <div style="font-size: 1.1rem; line-height: 1.8;"><?= $kaidah['penjelasan'] ?></div>
                            <?php else: ?>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="contoh" name="contoh" rows="4"
                                  placeholder="Berikan contoh-contoh penggunaan kaidah ini..."><?= esc($kaidah['contoh'] ?? '') ?></textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                        ...
                        <div class="row g-2">
                            <div class="col-4">
                                ...
                                <input type="radio" name="tingkat_kesulitan" value="mudah" class="d-none"
                                       <?= (old('tingkat_kesulitan', $kaidah['tingkat_kesulitan']) === 'mudah') ? 'checked' : '' ?> required>
                            </div>
                            <div class="col-4">
                                ...
                                <input type="radio" name="tingkat_kesulitan" value="sedang" class="d-none"
                                       <?= (old('tingkat_kesulitan', $kaidah['tingkat_kesulitan']) === 'sedang') ? 'checked' : '' ?>>
                            </div>
                            <div class="col-4">
                                ...
                                <input type="radio" name="tingkat_kesulitan" value="sulit" class="d-none"
                                       <?= (old('tingkat_kesulitan', $kaidah['tingkat_kesulitan']) === 'sulit') ? 'checked' : '' ?>>
                            </div>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control" id="urutan" name="urutan"
                               value="<?= esc(old('urutan', $kaidah['urutan'])) ?>" min="1">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" id="status" name="status">
                            <option value="aktif" <?= (old('status', $kaidah['status']) === 'aktif') ? 'selected' : '' ?>>Aktif</option>
                            <option value="nonaktif" <?= (old('status', $kaidah['status']) === 'nonaktif') ? 'selected' : '' ?>>Nonaktif</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle me-2"></i>Update Kaidah
                        </button>
                        <a href="<?= site_url('kaidah/' . $kaidah['id_materi']) ?>" class="btn btn-outline-secondary">
