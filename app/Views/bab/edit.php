...
<?= $this->section('title') ?>Edit Bab - <?= $this->endSection() ?>

<?= $this->section('content') ?>
<!-- Page Header -->
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold text-dark">Edit Bab</h4>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        ...
        <div class="alert alert-info d-flex align-items-center" role="alert">
            ...
            <div>
                <strong>Info:</strong> Anda sedang mengedit bab "<strong><?= esc($bab['nama_bab']) ?></strong>"
                <?php if ($bab['total_materi'] > 0): ?>
                <br><small>Terdapat <?= $bab['total_materi'] ?> materi dan <?= $bab['total_soal'] ?> soal yang terkait dengan bab ini.</small>
                <?php endif; ?>
            </div>
        </div>
        ...
        <form method="POST" action="<?= site_url('bab/' . $bab['id_bab']) ?>">
            ...
            <div class="row">
                <div class="col-md-8 mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_bab" name="nama_bab"
                           placeholder="Contoh: BAB 1: KALAM" value="<?= old('nama_bab', $bab['nama_bab']) ?>" required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control" id="urutan" name="urutan"
                           placeholder="1" value="<?= old('urutan', $bab['urutan']) ?>" min="1" required>
                    <div class="invalid-feedback">
                        Urutan wajib diisi
                    </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4"
                          placeholder="Deskripsi bab (opsional)"><?= old('deskripsi', $bab['deskripsi']) ?></textarea>
                ...
                <div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="is_active" id="status_aktif"
                               value="1" <?= old('is_active', $bab['is_active']) == '1' ? 'checked' : '' ?> required>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?= site_url('bab/' . $bab['id_bab']) ?>" class="btn btn-info">
