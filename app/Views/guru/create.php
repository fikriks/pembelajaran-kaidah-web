...
<?= $this->section('title') ?>Tambah Guru - <?= $this->endSection() ?>
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold text-dark">Tambah Guru Baru</h4>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            ...
            <div class="alert alert-info d-flex align-items-center" role="alert">
                ...
                <div>
                    <strong>Info:</strong> Password minimal 6 karakter. Guru akan memiliki hak akses untuk mengelola materi kaidah dan soal, serta melihat progress pembelajaran siswa.
                </div>
            </div>

            <!-- Form -->
            <form method="post" action="<?= site_url('guru/store') ?>" class="needs-validation" novalidate>
                <?= csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card border-primary bg-light">
                            <div class="card-body p-3">
                                ...
                                <div class="small">
                                    <strong>Akses Guru:</strong>
                                    <ul class="mb-2">
                                        <li>✅ Kelola materi kaidah</li>
                                        <li>✅ Kelola soal pembelajaran</li>
                                        <li>✅ Lihat progress siswa</li>
                                        <li>✅ Akses laporan pembelajaran</li>
                                        <li>❌ Kelola pengguna (hanya admin)</li>
                                    </ul>
                                    <strong class="text-warning">Catatan:</strong> Role guru akan otomatis diset sebagai "GURU" dan tidak dapat diubah.
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="small">
                                    <ul class="mb-0">
                                        ...
                                        <li>Aktifkan status jika guru siap menggunakan sistem</li>
                                        <li>Generate password untuk password yang aman</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="ti ti-device-floppy me-2"></i>Simpan Guru
                            </button>
